-- Trazabilidad de sincronizaciones con catalog-service.
-- Idempotente: la tabla se crea si no existe.
...
CREATE INDEX IF NOT EXISTS "idx_catalog_sync_log_category_synced" ON "catalog_sync_log_base_entity" ("categoryCode", "syncedAt" DESC);
CREATE INDEX IF NOT EXISTS "idx_catalog_sync_log_outcome" ON "catalog_sync_log_base_entity" ("outcome");
