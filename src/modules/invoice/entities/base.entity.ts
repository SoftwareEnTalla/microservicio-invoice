...
export abstract class BaseEntity {
  ...
  @Column({ type: 'varchar', length: 100, nullable: false,comment: 'Este es un campo del creador de la instancia de Invoice' })
  @IsString()
  @IsOptional()
  ...
  @Column({ type: 'boolean', nullable: false,comment: 'Campo para muestrar si la instancia de Invoice está activa o no' })
  @IsBoolean()
