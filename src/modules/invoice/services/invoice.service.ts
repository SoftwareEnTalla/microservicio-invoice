...
export class InvoiceService {
  ...
  async findByField(field: string, value: any, page: number, limit: number): Promise<Invoice[]> {
    return this.repository.findByField(field, value, page, limit);
  }

  async findWithPagination(options: any, page: number, limit: number): Promise<Invoice[]> {
  ...
  async update(id: string, partialEntity: Partial<Invoice>): Promise<Invoice | null> {
