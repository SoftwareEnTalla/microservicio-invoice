...
import { InvoiceCreatedEvent } from './invoicecreated.event';
import { InvoiceUpdatedEvent } from './invoiceupdated.event';
import { InvoiceDeletedEvent } from './invoicedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'invoice-created': createEventDefinition('invoice-created', InvoiceCreatedEvent, EVENT_DEFINITION_OVERRIDES['invoice-created']),
  'invoice-updated': createEventDefinition('invoice-updated', InvoiceUpdatedEvent, EVENT_DEFINITION_OVERRIDES['invoice-updated']),
  'invoice-deleted': createEventDefinition('invoice-deleted', InvoiceDeletedEvent, EVENT_DEFINITION_OVERRIDES['invoice-deleted']),
